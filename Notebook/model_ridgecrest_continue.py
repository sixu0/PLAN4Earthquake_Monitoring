...
class location_head(torch.nn.Module):
    ...
    def forward(self, x,station_loc, batch,edge_index):
        ...
        x = self.Graph_agg1(x, edge_index)
        x = self.Graph_agg2(x, edge_index)
...
class Main_GCNN(torch.nn.Module):
    ...
    def forward(self, x,station_loc,batch,edge_index):
        ...
        aux_out_offset,aux_out_depth = self.aux_head(out, station_loc,batch, edge_index)
        ...
        return out_p,out_s,aux_out_offset,aux_out_depth,dtp,dts
